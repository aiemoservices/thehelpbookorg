...
<head>
  ...
  <title>Animals (The Helpbook Pasumitra) | The Helpbook Foundation</title>
  <?php
...
<body>
  ...
  <div class="adoptList">
    <div class="cardContains">
      <div class="adoption-card">
        ...
        <p>She takes a little time to warm up to new people but enjoys the company of those who are confident
          around her.</p>
    ...
    <div class="cardContains">
      <div class="adoption-card">
        ...
        <p>Playful and affectionate, these adorable pups are looking for loving homes. They enjoy cuddles, fun,
          and are ready to be your new best friends!</p><br>
        <br>
        <button class="shareButton1" id="shareButton">Share&nbsp;<i class="fa-solid fa-share"></i></button>
        <a class="register adopt-button" href="/contact.php">Contact</a>
      </div>
    </div>
    ...
    <div class="cardContains">
      <div class="adoption-card">
        ...
        <h2>Labrador Mix!</h2>
        <p>Playful and affectionate, adorable pup is looking for loving home. He enjoys cuddles, fun, and are
          ready to be your new best friend!</p><br><br>
        <!--<button id="shareButton">Share&nbsp;<i class="fa-solid fa-share"></i></button>-->
        <button class="shareButton1" disabled>Share&nbsp;<i class="fa-solid fa-share"></i></button>
        <a class="register adopt-button" disabled>Adopted</a>
      </div>
  ...
  <section class="adopt openbtn" id="adopt">
    ...
    <div class="content">
      <h2>Foster</h2>
      <p>"Our foster program offers temporary homes to animals until they find a permanent family. By fostering,
        you offer these animals a safe space and a chance at a new life. Join us in caring for these animals in
  ...
  <section class="foster openbtn" id="foster">
    ...
    <div class="content">
      <h2>Donate</h2>
      <p>""Moving to a new place or country? Through our Pet Donation Program, The Helpbook Foundation provides a
        safe and caring environment for pets that need rehoming. By donating your pet, you can ensure they’ll
        receive the love and care they deserve, connecting them with a future family ready to welcome them.""
      </p>
    </div>
  </section>
