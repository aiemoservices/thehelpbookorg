...
<head>
    ...
    <title>The Helpbook Foundation | Food Donation</title>
        <?php
...
<div class="mainContainer">
    <div class="form-container">
        ...
        <form action="./admin/adoptForm.php" method="POST" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                <label for="petType">Type of Food</label>
                <select id="petType" name="petType" required>
                    <option value="">Select food</option>
                    <option value="Dry Goods">Dry Goods</option>
                    <option value="Bevarages">Bevarages (Water Bottles, Juice, etc.)</option>
                    <option value="Baby Foods">Baby Foods</option>
                    <option value="Baby Foods">Others</option>
                </select>
                <span class="error-message" id="errorPetType">Please select a type of food.</span>
            </div>
            
            <div class="form-group">
                <label for="message">Address and Details</label>
                <textarea id="message" name="message" required></textarea>
                <span class="error-message" id="errorMessage">Please write address and details</span>
            </div>
