...
<style>
    ...
    .hero {
        position: relative;
        background-image: url('./assets/education.webp'); /* Placeholder for education background */
...
<div class="img">
    <img src="./assets/new/education3.webp" alt="">
</div>
 <div class="content">
    <h2>Teacher</h2>
...
<div class="img">
    <img src="./assets/new/education2.webp" alt="">
</div>
 <div class="content">
    <h2>Student</h2>
...
<div class="img">
    <img src="./assets/new/education1.webp" alt="">
</div>
 <div class="content">
    <h2>Join</h2>
    ...
    <section class="student openbtn" id="other">
        <div class="img">
            <img src="./assets/education.webp" alt="">
        </div>
         <div class="content">
            <h2>Other</h2>
    ...
    <div class="quote-section">
        <div class="quote-content">
            <img src="./assets/apj2008.webp" alt="Dr. A.P.J. Abdul Kalam" class="quote-image">
