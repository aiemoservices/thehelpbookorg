...
<head>
    ...
    <meta property="og:image" content="https://thehelpbook.org/assets/new/about3.webp">
    ...
    <meta name="twitter:image" content="https://thehelpbook.org/assets/new/about3.webp">
...
<body>
    ...
    <style>
        ...
        .hero {
            ...
            position: relative;
            background-image: url('./assets/new/about3.webp'); /* Placeholder for education background */
    ...
    <section class="hero env">
        <div class="carousel-content1">
          ...
          <p>At The HelpBook Foundation, we strive to create lasting positive change through sustainability, community health, and social responsibility, inspiring individuals to take meaningful actions for a better society.</p>
          <div class="pg-follow">
          ...
          <section class="community openbtn" id="community">
              <div class="img">
                  <img src="./assets/new/cleaning2.webp" alt="Community Clean-up">
              </div>
              <div class="content">
                <h2>What we do?</h2>
          ...
          <section class="wildlife openbtn" id="wildlife">
              <div class="img">
                  <img src="./assets/new/about2.webp" alt="Wildlife Conservation">
              </div>
   ...
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 180"><path fill="#f2effd" fill-opacity="1" d="M0,32L48,48C96,64,192,96,288,96C384,96,480,64,576,58.7C672,53,768,75,864,90.7C960,107,1056,117,1152,106.7C1248,96,1344,64,1392,48L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
          ...
          <section class="awareness openbtn" id="awareness">
              <div class="img">
                  <img src="./assets/env.webp" alt="Environmental Awareness">
              </div>
              <div class="content">
          ...
          <section class="clean-energy openbtn">
              <div class="img">
                  <img src="./assets/new/cleaning3.webp" alt="Clean Energy Initiatives">
              </div>
              <div class="content right">
    ...
    <div class="left">
        <img src="./assets/new/dog.webp" alt="" srcset="">
    </div>
    <div class="right">
        ...
        <div class="adopt margin-50">
            <a href="./adoption.php" class="register"><i class="fa-solid fa-paw"></i>&nbsp;Adopt</a>
        </div>
    </div>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 80"><path fill="#eee" fill-opacity="1" d="M0,32L80,42.7C160,53,320,75,480,80C640,85,800,75,960,69.3C1120,64,1280,64,1360,64L1440,64L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>
    ...
    <div class="imgTree">
        <div class="sideOne">
            <img src="./assets/tree (1).webp" alt="" srcset="">
            <img src="./assets/tree (2).webp" alt="" srcset="">
            <img src="./assets/tree (3).webp" alt="" srcset="">
            <img src="./assets/tree (7).webp" alt="" srcset="">
        </div>
        <div class="sideTwo">
            <img src="./assets/tree (4).webp" alt="" srcset="">
            <img src="./assets/tree (5).webp" alt="" srcset="">
            <img src="./assets/tree (6).webp" alt="" srcset="">
            <img src="./assets/tree (8).webp" alt="" srcset="">
        </div>
    </div>
