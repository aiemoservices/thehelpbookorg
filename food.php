...
<head>
    ...
    <meta property="og:image" content="https://thehelpbook.org/assets/health.webp">
    ...
    <meta name="twitter:image" content="https://thehelpbook.org/assets/health.webp">
...
<style>
    ...
    .hero {
        position: relative;
        background-image: url('./assets/health.webp'); /* Placeholder for education background */
    ...
    <section class="hero food">
        <div class="carousel-content1">
          ...
          <div class="pg-follow">
            <a href="./donateFood.php" class="follow-btn1">Donate Food</a>
          </div>
        </div>
    </section>
