...
<head>
  ...
  <title>Blood Donation (The Helpbook Raktdaan) | The Helpbook Foundation</title>
  <?php
...
<body>
  ...
  <style>
    ...
    .hero {
      position: relative;
      background-image: url('./assets/blooddon.webp');
...
.content.right {
    ...
    .overlay {
      ...
      /* Optional: Use this for a darker effect */
      z-index: -1;
    }
  ...
  <section class="community openbtn" id="community">
    ...
    <div class="content">
      ...
      <p>Every blood donation brings hope to those in need. By giving a little, you offer a lot — a chance at life,
        health, and recovery. Join us in making a difference.</p>
    </div>
  </section>
  ...
  <section class="wildlife openbtn" id="wildlife">
    ...
    <div class="content right">
      ...
      <p>In critical moments, every drop counts. Request blood to help loved ones receive the essential care they need.
        Together, we can support life-saving treatments when it matters most.</p>
    </div>
  </section>
